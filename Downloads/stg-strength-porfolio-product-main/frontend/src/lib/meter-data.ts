...
export const METER_STRENGTHS: MeterStrength[] = [
  ...
  {
    id: "nakokulmanottokyky",
    name: "Näkökulmanottokyky",
    virtue: "Viisaus ja tieto",
    statements: [
  ...
  },
  {
    ...
    statements: [
      ...
      {
        text: "”En pysy asettamissani tavoitteissa ja vastoinkäymiset saavat minut luovuttamaan herkästi.”",
        reversed: true,
      },
    ],
  },
  {
    ...
    statements: [
      ...
      {
        text: "”Saatan joissakin tilanteissa/usein ajatella tai käyttäytyä toisin kuin tavallisesti, jotta minut hyväksytään.”",
        reversed: true,
      },
    ],
  },
  {
    ...
    statements: [
      ...
      {
        text: "”Olen passiivinen enkä innostu helposti uusista asioista ja ihmistä.”",
        reversed: true,
      },
    ],
  },
  ...
  },
  {
    ...
    statements: [
      ...
      {
        text: "”Minun on vaikea ottaa vastaan toisten osoittamaa läheisyyttä ja rakkautta.”",
        reversed: true,
      },
    ],
  },
  {
    ...
    statements: [
      ...
      {
        text: "”Tunnen, että ’toisten onni on minulta pois’ enkä osaa iloita toisen onnistumisista.”",
        reversed: true,
      },
    ],
  },
  {
    id: "sosiaalinen_alykkyys",
    name: "Sosiaalinen älykkyys",
    virtue: "Inhimillisyys",
    statements: [
  ...
  },
  {
    id: "ryhmatyotaito",
    name: "Ryhmätyötaidot",
    virtue: "Oikeudenmukaisuus",
    statements: [
      {
        text: "”Parhaat puoleni pääsevät käyttöön ryhmässä, ja minua motivoi ryhmän onnistuminen.”",
      },
      {
        text: "”En ota mielelläni vastuuta ryhmän jäsenenä ja olen mieluummin hieman passiivinen.”",
        reversed: true,
      },
    ],
  },
  {
    ...
    statements: [
      ...
      {
        text: "”Ennakkoluuloni ja tunteeni vaikuttavat siihen, miten kohtelen toisia ihmisiä.”",
        reversed: true,
      },
    ],
  },
  {
    ...
    statements: [
      ...
      {
        text: "”En saa kovin helposti toisia innostettua mukaan yhteiseen tekemiseen.”",
        reversed: true,
      },
    ],
  },
  {
    id: "anteeksiantavuus",
    name: "Anteeksiantavuus",
    virtue: "Kohtuullisuus",
    statements: [
      {
  ...
  },
  {
    ...
    statements: [
      ...
      {
        text: "”Minun on vaikea vastustaa turhaa tekemistä, vaikka olisin niin päättänyt (esimerkiksi kännykän jatkuva näpelöinti).”",
        reversed: true,
      },
    ],
  },
  {
    id: "kauneuden_arvostaminen",
    meterFieldId: "kauneuden_arvostus",
    name: "Kauneuden ja erinomaisuuden arvostus",
    virtue: "Henkisyys",
    statements: [
      { text: "”Huomaan kauniita yksityiskohtia ja pysähdyn usein niiden äärellä.”" },
      {
        text: "”Pysähdyn harvoin taiteen tai ympäristön kauneuden äärelle, enkä kiinnitä usein huomiotani yksityiskohtiin.”",
        reversed: true,
      },
    ],
  },
  ...
  },
  {
    ...
    statements: [
      ...
      {
        text: "”En juuri koskaan mieti elämän suurempiin merkityksiin liittyviä asioita.”",
        reversed: true,
      },
    ],
  },
