...
-- New school-admin invitations use high-entropy ADMIN-* codes generated by the server.

-- Legacy SCHOOL### rows were predictable and are no longer valid invitations.
-- The schools.code value may remain as an internal school identifier.
...
BEGIN
  ...
  -- Only the new high-entropy school-admin invitation format is accepted.
...
-- one-time teacher invitations created by a school admin. Predictable school
-- identifiers and school-admin codes can no longer grant the teacher role.
