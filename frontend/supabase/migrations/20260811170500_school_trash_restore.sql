...
-- Normal class deletion still cleans up after 60 days. Classes suspended only
-- because their school is in the 90-day trash must survive until the school is
-- either restored or permanently purged.
...
-- Deleted schools stay inactive regardless of billing dates.
