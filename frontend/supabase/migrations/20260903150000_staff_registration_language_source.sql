-- Staff domain/language model.
-- Current language remains changeable in profiles.language.
-- Registration language/domain preserve the original staff registration source.
