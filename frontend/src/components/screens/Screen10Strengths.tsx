    ...
    <div className="relative h-full min-h-0 w-full overflow-x-hidden overflow-y-auto px-[3%] pb-16 pt-6 text-white">
      <div className="grid min-h-[760px] grid-cols-[0.25fr_0.75fr] gap-7">
        <div className="relative min-w-0">
          <h1 className="font-display text-[42px] font-medium leading-[1.12] tracking-[-0.01em]">
            {tr("Minä olen")}
          </h1>

          <p className="mt-8 max-w-[290px] font-display text-[22px] font-medium leading-[1.4]">
            {tr("Muuta muilta saamasi palaute lauseiksi minä muotoon:")}
          </p>

          <div className="mt-7 max-w-[290px] text-[21px] font-normal leading-[1.45]">
          ...
          <img
            ...
            className="pointer-events-none absolute bottom-[-55px] left-[-95px] h-[520px] w-auto max-w-none select-none object-contain"
          />
        </div>
        ...
        <div className="relative min-h-[760px] min-w-0">
          {NOTES.map((note) => (
            ...
            >
              <p className="mb-5 shrink-0 text-center font-display text-[15px] font-medium uppercase leading-[1.2] tracking-[0.2px] text-black">
                {tr("Minä olen ...")}
              </p>

              <div className="flex flex-1 items-center">
                <Screen10StrengthSelect
                  index={note.id - 1}
...
function Screen10StrengthSelect({
  index,
  fieldKey,
  language,
  selectedValues,
