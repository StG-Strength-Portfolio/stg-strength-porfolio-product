...
type PortfolioPresentationBackRoute =
  | "/teacher/dashboard"
  | "/school-admin/dashboard"
  | "/superadmin/demo/principal";

/**
 * Read-only classroom/projector view of the student Strength Portfolio.
 * Teacher and School Admin routes intentionally share this exact renderer so
 * both roles always present the same 106-screen product experience.
 */
export function PortfolioPresentation({
  backTo,
  persistLanguage = true,
}: {
  backTo: PortfolioPresentationBackRoute;
