...
// @lovable-new 2026-08-05 — shared growth chart + own-events hook for the student view.
...
function StudentStrengthsPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-6 px-4 py-8">
      ...
      {/* @lovable-new 2026-08-05 — Student-only Strength Collection Growth chart:
          reuses the report chart with the signed-in student's own events, a
          30/90/365-day selector (default 30) and no "Show all" button. */}
      <StrengthGrowthChart
        events={events}
        lang={lang}
        showRangeControls
      ...
      {/* @lovable-new 2026-08-05 — Section order per spec: Top 5, growth chart,
          then the full Strength Collection card, then secondary sections. */}
